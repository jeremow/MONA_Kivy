...
def new_figure_manager_given_figure(num, figure, title=''):
    '''Create a new figure manager instance for the given figure.
    '''
    canvas = FigureCanvasKivy(figure)
    manager = FigureManagerKivy(canvas, num, title)
    global my_canvas
    global toolbar
...
class NavigationToolbar2Kivy(NavigationToolbar2):
    ...
    def __init__(self, canvas, title):
        # MODIF FAITE PAR JEREMY LE 05/05/21 POUR MODIFIER LE TITRE l.861 et 906
        self.actionbar = ActionBar(pos_hint={'top': 1.0})
        super(NavigationToolbar2Kivy, self).__init__(canvas, title)
    ...
    def _init_toolbar(self, title):
        ...
        # MODIF FAITE PAR JEREMY LE 05/05/21 POUR MODIFIER LE TITRE l.860 et 905
        actionprevious = ActionPrevious(title=title, with_previous=False) # title = "Navigation"
...
class FigureManagerKivy(FigureManagerBase):
    ...
    def __init__(self, canvas, num, title):
        super(FigureManagerKivy, self).__init__(canvas, num)
        self.canvas = canvas
        self.toolbar = self._get_toolbar(title)
    ...
    def _get_toolbar(self, title):
        if rcParams['toolbar'] == 'toolbar2':
            toolbar = NavigationToolbar2Kivy(self.canvas, title)
        else:
            toolbar = None
        return toolbar
